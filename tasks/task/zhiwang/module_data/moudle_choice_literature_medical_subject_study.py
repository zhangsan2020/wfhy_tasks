...
class MoudleChoice():
    ...
    def choice_item(self):
        if os.path.exists('old_literature_medical_sub_study.json'):
            with open('old_literature_medical_sub_study.json', 'r', encoding='utf-8') as f:
                data = f.read()
        else:
            data = None
        ...
        for year in range(max_year, min_year, -1):
            ...
            # 选择每一年
            with open('old_literature_medical_sub_study.json', 'w', encoding='utf-8') as f:
