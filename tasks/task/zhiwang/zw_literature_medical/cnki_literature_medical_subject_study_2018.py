...
class ZwSpider():
    ...
    def __init__(self):
        ...
        self.ori_jsondata_url = './task/zhiwang/moudle_data/old_literature_medical_sub_study.json'
        ...
        for item in page_item_data:
            ...
            if duplicate_status == 1:
                ...
                if flag_success == 0:
                    ...
                    continue
                if res.status_code == 200 and 'pdfDown' in res.text and '分页下载' not in res.text:
                    self.havepdfdown = 0
