...
class ZwSpider():
    ...
    def __init__(self):
        ...
        self.ori_jsondata_url = './task/zhiwang/moudle_data/old_参考文献_手术_年_学科_主题.json'
        ...
        # self.searchinfo = {'model': '参考文献', 'keywords': '心血管'}
        self.searchinfo = {'model': '参考文献', 'keywords': '手术'}
    ...
    def save(self, item):
        ...
        item['origin_moudle'] = '参考文献_手术_学科_主题_{}'.format(self.year)
