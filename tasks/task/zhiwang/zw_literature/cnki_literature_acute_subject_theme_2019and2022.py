...
class ZwSpider():
    ...
    def __init__(self):
        ...
        self.ori_jsondata_url = './task/zhiwang/moudle_data/old_参考文献_急性_学科_主题.json'
        ...
        self.searchinfo = {'model': '参考文献', 'keywords': '急性'}
    ...
    def save(self, item):
        ...
        item['origin_moudle'] = '参考文献_急性_学科_主题_{}'.format(self.year)
