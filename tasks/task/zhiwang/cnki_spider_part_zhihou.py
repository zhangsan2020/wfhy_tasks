...
class ZwSpider():
    ...
    def get_searchsql(self):
        ...
        # self.queryjson =
        print('选择的data数据: ',data)
        r = self.session.post(self.list_url, data=data1, headers=self.headers_list, timeout=(5, 20))
        print('这是选择2022年之后的数据',r.text)
        self.get_choice_item()
        exit()
        # print(self.session.cookies)
        # self.after_request_list(0)
        # self.get_resulturl_data()
        self.queryjson={"Platform": "", "DBCode": "CFLS", "KuaKuCode": "CJFQ,CDMD,CIPD,CCND,CISD,SNAD,BDZK,CCJD,CCVD,CJFN", "QNode": {
            "QGroup": [{"Key": "Subject", "Title": "", "Logic": 1,
                        "Items": [{"Title": "作者单位", "Name": "AF", "Value": "医院", "Operate": "%"}], "ChildItems": []},
                       {"Key": "SCDBGroup", "Title": "", "Logic": 1, "Items": [], "ChildItems": [
                           {"Key": "3", "Title": "", "Logic": 1, "Items": [
                               {"Key": "2022", "Title": "2022", "Logic": 2, "Name": "年", "Operate": "", "Value": "2022",
                                "ExtendType": 0, "ExtendValue": "", "Value2": "", "BlurType": ""}],
                            "ChildItems": []}]}]}}
        # res = self.session.get('https://recsys.cnki.net/RCDService//api/UserDataCenter/IsCollectFile?idenID=&clientID=1221019081600213530&userIP=223.71.72.248&fileIDs=ZCXW202210001;HSJB202210006;SLYY202210011;XYXZ202209024;XYXZ202209049;LCFK202210032;JYTZ202205041;JJXZ202209015;JYTZ202205047;ZGWK202209013;GQYK202204032;NBYX202208036;NBYX202207056;ZHLN202207002;ZGJW202205004;SYLC202208020;SZZX202205015;LZBJ202201001;TTXZ202201007;ZJYE202203012;&platformURL=kns.cnki.net/kns8@KNS8',headers=self.headers_init)
        # print(res.text)
        # self.get_resgroup()
        #
        # self.get_choice_item()
        # self.session.post(self.list_url, data=data, headers=self.headers_list, timeout=(5, 20))
        # self.queryjson = {"Platform":"","DBCode":"CFLS","KuaKuCode":"CJFQ,CDMD,CIPD,CCND,CISD,SNAD,BDZK,CCJD,CCVD,CJFN","QNode":{"QGroup":[{"Key":"Subject","Title":"","Logic":1,"Items":[{"Title":"作者单位","Name":"AF","Value":"医院","Operate":"%"}],"ChildItems":[]},{"Key":"SCDBGroup","Title":"","Logic":1,"Items":[],"ChildItems":[{"Key":"2","Title":"","Logic":1,"Items":[{"Key":"E066?","Title":"外科学","Logic":2,"Name":"专题子栏目代码","Operate":"","Value":"E066?","ExtendType":14,"ExtendValue":"","Value2":"","BlurType":""}],"ChildItems":[]},{"Key":"3","Title":"","Logic":1,"Items":[{"Key":"2022","Title":"2022","Logic":2,"Name":"年","Operate":"","Value":"2022","ExtendType":0,"ExtendValue":"","Value2":"","BlurType":""}],"ChildItems":[]},{"Key":"4","Title":"","Logic":1,"Items":[{"Key":"16","Title":"技术开发","Logic":2,"Name":"人工标识码","Operate":"","Value":"16","ExtendType":14,"ExtendValue":"","Value2":"","BlurType":""}],"ChildItems":[]}]}]}}
        # self.get_choice_item()
        # print('结果在上面...'*10)
        # exit()
        # exit()
