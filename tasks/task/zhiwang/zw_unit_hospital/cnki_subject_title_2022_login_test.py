...
from ..login_tsg import LoginTrun
...
class ZwSpider():
    ...
    def __init__(self):
        ...
        self.login_turn = LoginTrun()
        cookies_data = self.login_turn.page_turn()
        # c_jar = requests.cookies.RequestsCookieJar()
        # cookies = requests.utils.cookiejar_from_dict(cookies_data, cookiejar=None, overwrite=True)
        for cookie in cookies_data:
            for k, v in cookie.items():
                cookie[k] = str(v)
            print('这是单个cookie {}'.format(cookie))
            self.session.cookies.update(cookie)
        print(self.session.cookies)
        self.list_url = 'http://kns.cnki.net.forest.vpn358.com/kns8/Brief/GetGridTableHtml'
    ...
    def get_searchsql(self):
        ...
        # rr = self.session.get('http://www.cnki.net.forest.vpn358.com/')
        print(self.session.cookies)
        time_ = int(time.time() * 1000)
        url = 'http://kns.cnki.net.forest.vpn358.com/kns8/defaultresult/index'
        headers_ = {
            ...
            'Origin': 'http://www.cnki.net.forest.vpn358.com',
            'Content-Type': 'application/x-www-form-urlencoded',
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36',
            'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
            'Referer': 'http://www.cnki.net.forest.vpn358.com/',
            'Accept-Encoding': 'gzip, deflate',
            'Accept-Language': 'zh-CN,zh;q=0.9',
            'Cookie': 'Ecp_ClientId=a221031100401143249; Ecp_session=1; SID_kns_new=kns25128008; ASP.NET_SessionId=s1onrw41w0uqkf2uin1ina55; SID_kns8=25123163; CurrSortFieldType=desc; Ecp_ClientIp=-1; SID_kcms=025126021; Ecp_showrealname=1; knsLeftGroupSelectItem=1%3B2%3B; dblang=ch; dsorder=pubdate; CurrSortField=%e5%8f%91%e8%a1%a8%e6%97%b6%e9%97%b4%2f(%e5%8f%91%e8%a1%a8%e6%97%b6%e9%97%b4%2c%27time%27); vpn358_sid=2be9d6cd6a0a7fdde6e2e03da04840d7; Ecp_LoginStuts={"IsAutoLogin":false,"UserName":"NJ0099","ShowName":"%e5%8d%97%e4%ba%ac%e6%a3%ae%e6%9e%97%e8%ad%a6%e5%af%9f%e5%ad%a6%e9%99%a2","UserType":"bk","BUserName":"","BShowName":"","BUserType":"","r":"NytPHX","Members":[]}; c_m_LinID=LinID=WEEvREcwSlJHSldSdmVpbisvQWlDWHoxS2U0R2tUOWZGTG5rWU9XU1BuRT0=$9A4hF_YAuvQ5obgVAqNKPCYcEjKensW4IQMovwHtwkF4VYPoHbKxJw!!&ot=10%2f31%2f2022%2016%3a59%3a28; LID=WEEvREcwSlJHSldSdmVpbisvQWlDWHoxS2U0R2tUOWZGTG5rWU9XU1BuRT0=$9A4hF_YAuvQ5obgVAqNKPCYcEjKensW4IQMovwHtwkF4VYPoHbKxJw!!;'
        }
        data = {
            'txt_1_sel': '{}'.format(self.searchinfo['model_match_data']),
        ...
        self.session.post(url, headers=headers_, data= data,timeout=(5, 20))
        # print(res.text)
        # print(self.session.cookies)
        # exit()
        # self.login()
    ...
    def get_page_list(self):
        ...
        # for year in years:
        year = '2022'
        with open('./task/zhiwang/zw_unit_hospital/old_单位_医院_subject_title_v0.json', 'r', encoding='utf-8') as f:
            data = f.read()
        moudle_datas = json.loads(data)[year]
        for moudle_data in moudle_datas:
            ...
            for title_info in moudle_data['title_info'].values():
                for page_num in range(1, 301):
                    ...
                    print('当前是 {} 年, 学科为: {}, 标题为: {} 中的第 {} 页数据'.format(year, str(subject_info['subject_name']),
                                                                         title_info['title_type'] + title_info[
                                                                             'title_text'], page_num))
                    print('***' * 20)
    ...
    def save(self, item):
        ...
        item['origin_moudle'] = '单位_医院_学科_标题_2022'
