...
class ChinaSw():
    ...
    def __init__(self):
        ...
        self.tasks_path = './task/china_sw/chinasw_common_columns_config.json'
    ...
    def get_page_num(self, year):
        ...
        '''
        # list_url_before = 'http://www.sinomed.g.fg77.club/index.do?method=stat'
        # headers = {
        ...
        #     "Origin": "http://www.sinomed.g.fg77.club",
        #     "Referer": "http://www.sinomed.g.fg77.club/index.jsp",
        ...
        list_url = 'http://www.sinomed.g.fg77.club/crossSearch.do'
        data = {
                "sql": "DCS/1='{}' AND DP_YEAR/1='{}'".format(self.search_info['keywords'],self.cur_year),
                "dbs": "zh,en,lw,kp",
                "db": "zh",
                "pageNo": "1",
                "pageSize": "{}".format(self.search_info['page_size']),
                "ajax": "items",
                "searchword": "(\"{}\"[{}:常用字段]) AND (\"{}\"[时间]) ".format(self.search_info['keywords'],self.search_info['platform'],self.cur_year),
                "cmode": "tl",
                "orderBy": "LIFO",
                "flag": "true",
                "selected": "undefined",
        ...
        # http://www.sinomed.g.fg77.club/crossSearch.do?searchwordwm=手术标题:智能
        header_list = {
                "Host": "www.sinomed.g.fg77.club",
                "Connection": "keep-alive",
                "Content-Length": "304",
                ...
                "Origin": "http://www.sinomed.g.fg77.club",
                "Referer": "http://www.sinomed.g.fg77.club/crossSearch.do?searchwordwm={}{}".format(quote(self.search_info['keywords']),quote(self.search_info['platform'])),
                "Accept-Encoding": "gzip, deflate",
                "Accept-Language": "zh-CN,zh;q=0.9"
            }
    ...
    def get_page_list(self):
        ...
        data = {
            ...
            "pageSize": "{}".format(self.search_info['page_size']),
            "ajax": "items",
            "searchword": "(\"{}\"[{}:常用字段]) AND (\"{}\"[时间]) ".format(self.search_info['keywords'],
        ...
        header_list = {
            ...
            "Content-Type": "application/x-www-form-urlencoded",
            "Origin": "http://www.sinomed.g.fg77.club",
            "Referer": "http://www.sinomed.g.fg77.club/crossSearch.do?searchwordwm={}{}".format(
        ...
        for i in range(self.retry_down_list_max):
            ...
            try:
                ...
                if i >= 2:
                    time.sleep(random.uniform(180,300))
                    print('列表页连续超过3次出现异常, 休息3~5分钟, 重新登录获取数据')
                    self.login_again()
                continue
            res.encoding = 'utf-8'
                            ...
                            if pdf_flag and 'pdf.jpg' in pdf_flag[0].strip():
                                ...
                                if status == 1:
                                    ...
                                    try:
                                        ...
                                        self.item['origin'] = '不详'
                                    # http://www.sinomed.g.fg77.club/zh/detail.do?ui=2023103671
                                    self.item['detail_url'] = 'http://www.sinomed.g.fg77.club' + \
    ...
    def down_pdf(self, file_path):
        ...
        for i in range(self.retry_down_pdf_max):
            headers_pdf = {
                        "Host": "pdf.juhe.com.cn",
                        "Connection": "keep-alive",
                        "Upgrade-Insecure-Requests": "1",
                        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36",
                        "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                        "Referer": "http://www.sinomed.g.fg77.club/",
                        "Accept-Encoding": "gzip, deflate",
                        "Accept-Language": "zh-CN,zh;q=0.9"
                    }
            print('开始下载pdf文件...')
    ...
    def get_pdf_url(self, ti, id_):
        ...
        url = 'http://www.sinomed.g.fg77.club/zh/relatedLink.do?method=pdfLink'
        data = {
            "id": id_,
            "ti": ti,
            "db": "zh_pdf"
        ...
        headers = {
                    ...
                    "Content-Type": "application/x-www-form-urlencoded",
                    "Origin": "http://www.sinomed.g.fg77.club",
                    "Referer": "http://www.sinomed.g.fg77.club/crossSearch.do?searchwordwm={}".format(quote(self.search_info['keywords'])),
                    "Accept-Encoding": "gzip, deflate",
                    "Accept-Language": "zh-CN,zh;q=0.9",
                    # "Cookie": "history_cross=history_52324645-1_52324930-2_52326307-3_52326315-4_52326321-5; ddhgguuy_session=tp0cs5r7olcqhaejboc4ksv4u1; JSESSIONID=82F282ADEADA11D1B90DB8FE48372825; com.trs.idm.coSessionId=82F282ADEADA11D1B90DB8FE48372825; refreshedTimestamp=1677750058010; uuid=1677749790742.7073"
                }
