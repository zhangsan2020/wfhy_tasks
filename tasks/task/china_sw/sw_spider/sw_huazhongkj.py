...
class ChinaSw():
    ...
    def __init__(self):
        ...
        self.spider_at = 'win'
        self.owning_account = '6849_华中科技大学同济医学院'
    ...
    def get_page_num(self, year):
        ...
        '''
        list_url_before = 'http://www.sinomed.a.fg77.club/index.do?method=stat'
        headers = {
            ...
            "Origin": "http://www.sinomed.a.fg77.club",
            "Referer": "http://www.sinomed.a.fg77.club/index.jsp",
            "Accept-Encoding": "gzip, deflate",
            "Accept-Language": "zh-CN,zh;q=0.9",
            # "Cookie": "com.trs.idm.coSessionId=891B19C61E5D470DC9807D8AAEB2F760; history_cross=history_52108330-1_52108334-2_52108339-3; refreshedTimestamp=1676270978195; ddhgguuy_session=ktcun235bfb3mt00aivgpkc4h7; JSESSIONID=B5D44CE6F9A441E829612300ECC3764F; uuid=1676273474624.5574"
        }
        self.session.post(list_url_before,headers=headers)
        list_url = 'http://www.sinomed.a.fg77.club/crossSearch.do'
        data = {
        ...
        # http://www.sinomed.a.fg77.club/crossSearch.do?searchwordwm=手术标题:智能
        header_list = {
                "Host": "www.sinomed.a.fg77.club",
                "Connection": "keep-alive",
                "Content-Length": "306",
                ...
                "Origin": "http://www.sinomed.a.fg77.club",
                "Referer": "http://www.sinomed.a.fg77.club/crossSearch.do?searchwordwm={}{}:{}".format(quote(self.search_info['keywords']),quote(self.search_info['platform']),quote('智能')),
                "Accept-Encoding": "gzip, deflate",
                "Accept-Language": "zh-CN,zh;q=0.9"
            }
    ...
    def get_page_list(self):
        ...
        for i in range(self.retry_down_list_max):
            ...
            header_list = {
                ...
                "Content-Type": "application/x-www-form-urlencoded",
                "Origin": "http://www.sinomed.a.fg77.club",
                "Referer": "http://www.sinomed.a.fg77.club/crossSearch.do?searchwordwm={}{}:{}".format(
                            ...
                            if pdf_flag and 'pdf.jpg' in pdf_flag[0].strip():
                                ...
                                if status == 1:
                                    ...
                                    try:
                                        ...
                                        self.item['origin'] = '不详'
                                    # http://www.sinomed.a.fg77.club/zh/detail.do?ui=2023103671
                                    self.item['detail_url'] = 'http://www.sinomed.a.fg77.club' + \
    ...
    def down_pdf(self, file_path):
        ...
        for i in range(self.retry_down_pdf_max):
            headers_pdf = {
                ...
                "Referer": "http://www.sinomed.a.fg77.club/",
                "Accept-Encoding": "gzip, deflate",
                "Accept-Language": "zh-CN,zh;q=0.9",
            }
            print('开始下载pdf文件...')
    ...
    def get_pdf_url(self, ti, id_):
        ...
        url = 'http://www.sinomed.a.fg77.club/zh/relatedLink.do?method=pdfLink&sf_request_type=ajax'
        data = {
            "id": id_,
            "ti": ti,
            "db": "zh_pdf"
        ...
        headers = {
            ...
            "Content-Type": "application/x-www-form-urlencoded",
            "Origin": "http://www.sinomed.a.fg77.club",
            # "Referer": "http://www.sinomed.a.fg77.club/crossSearch.do?searchwordwm={}".format(quote('{}  {}时间'.format(self.search_info['keywords'],self.cur_year))),
            "Accept-Encoding": "gzip, deflate",
            "Accept-Language": "zh-CN,zh;q=0.9",
