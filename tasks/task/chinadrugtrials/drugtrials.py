...
class ChinaDrug():
    ...
    def __init__(self):
        ...
        self.mongo_cli = DtSql('wfhy_update', 'chinadrug_new_new')
        self.mongo_cli_commit = DtSql('wfhy_commit', 'chinadrug')
    ...
    def run(self):
        ...
        print('网站页面最大页码数为: {}, sql 中存储的最大页码数为: {}, 更新页码数为: {}'.format(web_max_page,sql_max_page,update_page_num))
        time.sleep(3)
