    ...
    def login_page_turn(self,owning_account):
        ...
        for i in range(10):
            ...
            if owning_account == '6849_超星3_华中科技大学':
                ...
                # http://qd.hknsspj.cn/interlibSSO/goto/46
                res = self.session.post('http://qd.hknsspj.cn/interlibSSO/goto/46', json=data,headers=headers)
                print(res.text)
...
login = LoginTrun('6849_维普_青岛市图书馆')
login.login_page_turn('6849_维普_青岛市图书馆')
