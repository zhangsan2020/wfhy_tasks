...
class ChaoXing():
    ...
    def __init__(self):
        ...
        self.domain = 'qikan.chaoxing.j.fg77.club'
    ...
    def get_page_list(self):
        ...
        list_url = "http://{}/searchjour?sw={}&strkey={}&stryear={}&strclassfy=16_-1&topsearch=4&adv=JN{}&aorp=a&nosim=1&size={}&isort=3&x=0_63&pages={}".format(self.domain,
        ...
        header_list = {
            ...
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36",
            "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
            "Referer": "http://{}/searchjour?sw={}&strkey={}&stryear={}&strclassfy=16_-1&topsearch=4&adv=JN{}&aorp=a&nosim=1&size={}&isort=3&x=0_63".format(self.domain,
                quote(self.search_info['keywords']), self.second_value,self.years_match[self.cur_year], quote_param,
    ...
    def run(self):
        ...
        for i in range(5):
            try:
                ...
                print('抓取时出现问题, 休息20~30分钟, 详情为: {}'.format(repr(e)))
