...
class ChaoXing():
    ...
    def __init__(self):
        ...
        self.cx_get_moudles = ChaoXingMoudle()
    ...
    def get_detail(self):
        ...
        headers = {
                ...
                "Referer": "http://qikan.chaoxing.j.fg77.club/searchjour?sw={}&topsearch=4&size={}".format(quote(self.search_info['keywords']),self.search_info['page_size']),
    ...
    def get_page_list(self):
        ...
        list_url = "http://qikan.chaoxing.j.fg77.club/searchjour?sw={}&strkey={}&stryear={}&strclassfy=16_-1&topsearch=4&adv=JN{}&aorp=a&nosim=1&size={}&isort=3&x=0_63&pages={}".format(
        ...
        header_list = {
            ...
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36",
            "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
            "Referer": "http://qikan.chaoxing.j.fg77.club/searchjour?sw={}&strkey={}&stryear={}&strclassfy=16_-1&topsearch=4&adv=JN{}&aorp=a&nosim=1&size={}&isort=3&x=0_63".format(
                quote(self.search_info['keywords']), self.second_value,self.years_match[self.cur_year], quote_param,
                ...
                if len(trs) > 0:
                    for tr in trs:
                        ...
                        if tr.xpath('.//td/a[@class="down"]'):
                            ...
                            if detail_url:
                                self.item['detail_url'] = urljoin('http://qikan.chaoxing.j.fg77.club/',detail_url[0])
