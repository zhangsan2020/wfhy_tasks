...
class ChaoXing():
    ...
    def get_detail(self):
        ...
        headers = {
                ...
                "Referer": "http://{}/searchjour?sw={}&topsearch=4&size={}".format(self.domain,quote(self.search_info['keywords']),self.search_info['page_size']),
