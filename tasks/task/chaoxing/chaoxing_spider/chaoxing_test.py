...
class ChaoXing():
    ...
    def __init__(self):
        ...
        self.tasks_path = './task/chaoxing/chaoxing_config.json'
    ...
    def get_page_num(self):
        ...
        if sql_page_data == 0:
            ...
            if sql_min_page == 1:
                ...
                elif new_page_num < 3 and total_num - cur_moudle_sql_total > 10:
                ...
                for year in range(self.search_info['max_year'], self.search_info['min_year'], -1):
                    ...
                    for second_name,second_value in second_moudles.items():
                        for three_name,three_value in three_moudles.items():
                            ...
                            self.update_task(self.search_info, have_start=1, is_running=1, origin_moudle=self.item['origin_moudle'],cur_year=self.cur_year)
                            ...
                            if data != 'cur_moudle_have_spider':
                                ...
                                print('开始抓取下一个模块数据!')
                            self.update_task(self.search_info, have_start=0, have_end=1,is_running=0,
                                             origin_moudle=self.item['origin_moudle'], cur_year=self.cur_year)
