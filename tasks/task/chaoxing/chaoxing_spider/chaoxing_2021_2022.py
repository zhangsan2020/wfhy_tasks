...
class ChaoXing():
    ...
    def __init__(self):
        ...
        self.tasks_path = './task/chaoxing/chaoxing_config_2021_2022.json'
    ...
    def login_again(self):
        try:
            ...
            print('重新登录出错,详情为: {}'.format(repr(e)))
            self.session = self.login_obj.login_page_turn(self.owning_account)
    ...
    def request_page_num(self):
        ...
        for i in range(self.retry_down_list_max):
            ...
            try:
                ...
                print('get_num时, 选取web最大数据出错!! {} '.format(repr(e)))
                time.sleep(3)
                continue
    ...
    def get_detail(self):
        ...
        if self.get_detailfail_num >= 10:
            print('连续 10 个pdf文件下载失败, 可能遇到反爬, 休息2~3分钟后, 重新登录一下, 继续抓取!!'.format(self.turn_page_num))
