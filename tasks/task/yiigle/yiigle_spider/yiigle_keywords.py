    ...
    def request_list(self):
        ...
        data = {
            ...
            "condition": {
                ...
                "journalTypeList": [],
                "sorting": "发表时间",
                "retrieve": " keywordCN:*{}* AND pYear:[* TO *] AND start:1 AND !isChMeAss:\"4\" AND !isChMeAss:\"4\" AND start:1 AND !isChMeAss:\"4\" AND start:1 AND !isChMeAss:\"4\" AND start:1 AND !isChMeAss:\"4\" AND start:1".format(self.keywords_)
            }
    ...
    def get_page_list(self):
        ...
        data = {
            ...
            "condition": {
                ...
                "journalTypeList": [],
                "sorting": "发表时间",
                "retrieve": " keywordCN:*{}* AND pYear:[* TO *] AND start:1 AND !isChMeAss:\"4\" AND !isChMeAss:\"4\" AND start:1 AND !isChMeAss:\"4\" AND start:1 AND !isChMeAss:\"4\" AND start:1 AND !isChMeAss:\"4\" AND start:1".format(
                    self.keywords_)
            }
