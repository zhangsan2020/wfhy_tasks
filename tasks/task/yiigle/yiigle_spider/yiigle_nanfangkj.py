...
class Yiigle():
    ...
    def __init__(self):
        ...
        self.owning_account = '6849_南方科技大学'
    ...
    def get_page_num(self, year):
        ...
        '''
        list_url = 'http://fjykdxnshfsfljsbhfkew883sdjfns.98tsg.com/getCore/manyElements'
        header_list = {
                ...
                if res.status_code == 200:
                    ...
                    if len(list_items) > 0:
                        for item in list_items:
                            ...
                            self.item['detail_url'] = 'http://fjykdxnshfsfljsbhfkew883sdjfns.98tsg.com/#/details?id=' + item['id']
