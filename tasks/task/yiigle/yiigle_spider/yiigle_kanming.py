    ...
    def request_list(self):
        ...
        data = {
            ...
            "condition": {
                ...
                "journalTypeList": [],
                "sorting": "发表时间",
                "retrieve": " periodicalName:*{}* AND pYear:[* TO *] AND start:1 AND start:1 AND start:1 AND start:1 AND start:1 AND start:1 AND start:1 AND start:1 AND start:1".format(
                    self.keywords_)
            }
        }
